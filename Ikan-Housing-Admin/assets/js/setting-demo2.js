...
function customCheckColor() {
	...
	if (logoHeader !== "white") {
		$('.logo-header .navbar-brand').attr('src', '../assets/img/kaiadmin/Ikanhousing-logowhite.svg');
	} else {
		$('.logo-header .navbar-brand').attr('src', '../assets/img/kaiadmin/Ikanhousing-logo.svg');
	}
}
