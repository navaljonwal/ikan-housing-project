      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">Individual contact</h3>
            <ul class="breadcrumbs mb-3">
              <li class="nav-home">
                <a href="#"><i class="icon-home"></i></a>
              </li>
              <li class="separator"><i class="icon-arrow-right"></i></li>
              <li class="nav-item"><a href="add">Individual contact</a></li>
            </ul>
          </div>
          ...
          <div class="card">
            <div class="card-header"><h4 class="card-title">Individual contact List</h4></div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                 ...
                 <tbody>
                                ...
                                <div style="display: flex; gap: 6px;">
                                  <a href="individual-contact" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> view</a>
